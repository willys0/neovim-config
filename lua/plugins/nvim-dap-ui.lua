...
return function(use)
    use {
        ...
        config = function()
            ...
            vim.keymap.set('n', '<Leader>cb', function() require('dap').toggle_breakpoint() end, { noremap = true, silent = true, desc = "Toggle breakpoint"})
            vim.keymap.set('n', '<Leader>cB', function() require('dap').set_breakpoint() end, { noremap = true, silent = true, desc = "Set breakpoint"})
            ...
            vim.keymap.set('n', '<Leader>cd', function() dapui.open() end, { noremap = true, silent = true, desc = "Open debugger UI"})
